//板载使用的是AT8236电机驱动，和tb6612不同，没有PWM接口，直接通过PWM控制IN1和IN2
//EN:PD3,电机使能，板载的电机使能开关
//motorA:PWMA2:TIM11->CCR1(IN1:PB9),	PWMA1:TIM10->CCR1(IN2:PB8)
//motorB:PWMB1:TIM9->CCR1(IN1:PE5),		PWMB2:TIM9->CCR2(IN2:PE6)
//motorC:PWMC1:TIM1->CCR2(IN1:PE11),	PWMC2:TIM1->CCR1(IN2:PE9)
//motorD:PWMD1:TIM1->CCR4(IN1:PE14),	PWMD2:TIM1->CCR3(IN2:PE13)
//PWMA1高电平时间大于PWMA2：正转
//PWMC1高电平时间大于PWMC2：正转
//PWMB1高电平时间大于PWMB2：反转
//PWMD1高电平时间大于PWMD2：反转

//初始化有：Enable_Pin()	  TIM1_PWM_Init(u16 arr,u16 psc)	TIM9_PWM_Init(u16 arr,u16 psc)	
//			TIM10_PWM_Init(u16 arr,u16 psc)		TIM11_PWM_Init(u16 arr,u16 psc)

#include "motor.h"
//使能开关PD3为低或高时电机允许动程序还没写
