//motorA编码器：PA15,PB3，使用TIM2
//motorB编码器：PB4,PB5，使用TIM3
//motorC编码器：PB6,PB7，使用TIM4
//motorD编码器：PA0,PA1，使用TIM5
//如Read_Encoder(2)，可返回TIM2，即motorA编码器
//初始化有Encoder_Init_TIM2()	Encoder_Init_TIM3()	
